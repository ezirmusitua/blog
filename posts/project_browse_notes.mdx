...
<Image alt="C4 Modeling" src="/assets/project_browse_notes/modeling.svg" className="bg-green p-2 object-contain object-center mx-auto" width={640} height={640} quality={75}></Image>
