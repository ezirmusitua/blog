...
![panel](/assets/unity-leancloud-rc/5d2aa3b6e130447695.png)
...
![deps1](/assets/unity-leancloud-rc/5d2aa5a48710941839.png)

![deps2](/assets/unity-leancloud-rc/5d2aa5a47388a44371.png)
...
![get app key 1](/assets/unity-leancloud-rc/5d2ae37f8163b18510.png)

![get app key 2](/assets/unity-leancloud-rc/5d2bc45bac88685136.png)
...
![ui](/assets/unity-leancloud-rc/5d2ac4aab9fe917759.png)

之后, 创建一个简单的 Message Item Prefab, 如下图所示

![prefab](/assets/unity-leancloud-rc/5d2ae2ce6627d51132.png)
...
![component1](/assets/unity-leancloud-rc/5d2ae3296f00471640.png)

完成之后运行项目, 试着发个消息看看效果

![sample1](/assets/unity-leancloud-rc/5d2ae4ecdbc0549758.png)
...
![another method](/assets/unity-leancloud-rc/5d2bc6dec8b9461234.png)

发送者 ID 为 FooBar 是因为我们在 `Conversation` 中硬编码了这个 Conversation 的另一个成员为 FooBar

对话 ID 的获取, LeanCloud 控制台的**存储管理**中获取到:

![screenshot1](/assets/unity-leancloud-rc/5d2ae5fe3929f85073.png)

发送之后的效果是:

![result](/assets/unity-leancloud-rc/5d2ae72314ffc57651.png)
