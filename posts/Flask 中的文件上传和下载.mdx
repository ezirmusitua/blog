...
![header](/assets/flask-file-upload/5bd7b36ad5b42.png)

在 flask 中, 对于 上传的文件数据 的获取主要是在 `werkzeug` 中实现的, 想要阅读源码(flask==1.0.2)可以参考以下路径：
...
![response](/assets/flask-file-upload/5bd7b36a90b48.png)
