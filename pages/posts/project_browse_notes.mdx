...
date: '2022/03/12'
excerpt: 'browse 是一个使用浏览器查看图片的工具。开发这个小工具的原因是在 MacOS 下无法直接使用 preview 查看动态的 webp 图片。'
...
<a target="_blank" href="/assets/project_browse_notes/modeling.svg" style="width: 100%;">
<img alt="C4 Modeling" src="/assets/project_browse_notes/modeling.svg" style="object-fit: contain; object-position: center" />
</a>
